...
class AudioManifestTest extends MandarinTestCase
{
    ...
    public function test_export_describes_every_ready_asset_and_its_sources_without_secrets_or_urls(): void
    {
        ...
        $this->artisan("mandarin:audio:export {$this->path}")
            ->assertSuccessful()
            ->expectsOutputToContain('mandarin-foundations@1.1.1')
        ...
        $this->assertSame([['courseId' => 'mandarin-foundations', 'contentVersion' => '1.1.1']], $manifest['courses']);
        ...
        $this->assertContains(['course_id' => 'mandarin-foundations', 'content_version' => '1.1.1', 'source_kind' => 'utterance', 'source_id' => '01a', 'variant' => 'slow', 'recipe_hash' => (string) $slow->recipe_hash], $manifest['sources']);
    }
    ...
    public function test_deployment_requires_the_manifest_to_cover_the_configured_course(): void
    {
        ...
        $this->artisan("mandarin:audio:import {$this->path} --dry-run --require-configured-course")
            ->assertFailed()
            ->expectsOutputToContain('Manifest does not cover configured course mandarin-foundations@1.1.1');
    }
